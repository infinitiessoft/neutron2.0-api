...
public class SubnetsControllerImpl implements SubnetsController {
	...
	@Override
	public SubnetTemplate show(ContainerRequestContext requestContext, String projectId, String subnetId) throws Exception {
		OpenstackRequestContext context = (OpenstackRequestContext) requestContext.getProperty("nova.context");
	...
	@Override
	public SubnetTemplate create(ContainerRequestContext requestContext, String projectId,
