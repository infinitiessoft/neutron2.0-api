...
public class DaseinSubnetsApi implements SubnetsApi {
	...
	@Override
	public List<Subnet> getSubnets(OpenstackRequestContext context, String projectId) throws Exception {
		if (context == null) {
		...
		while (vlanIterator.hasNext()) {
			...
			AsyncResult<Iterable<org.dasein.cloud.network.Subnet>> result =
					getSupport(context.getProjectId()).listSubnets(vlan.getProviderVlanId());
	...
	@Override
	public Subnet getSubnet(OpenstackRequestContext context, String projectId, String subnetId) throws Exception {
		if (context == null) {
			context = Context.getAdminContext("no");
		}
	...
	@Override
	public Subnet createSubnet(OpenstackRequestContext context, String projectId,
	...
	@Override
	public Subnet updateSubnet(OpenstackRequestContext context, String projectId, String subnetId,
			SubnetForCreateTemplate subnetForCreateTemplate) throws Exception {
		throw new UnsupportedOperationException("subnet update not supported");
	}

	@Override
	public void deleteSubnet(OpenstackRequestContext context, String projectId, String subnetId) throws Exception {
		if (context == null) {
			context = Context.getAdminContext("no");
		}
